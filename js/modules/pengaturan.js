        ...
        <section class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm">
                    ...
                    <div class="space-y-4">
                        ...
                        <button id="btn-gen-comprehensive-pdf" class="w-full text-left flex items-center py-3 px-4 border border-blue-300 text-blue-700 text-sm font-medium rounded-md hover:bg-blue-50 bg-blue-50"> <i class="fas fa-file-invoice mr-3 text-lg text-blue-600"></i> <div> <span>Download Laporan Komprehensif (Baru!)</span> <span class="block text-xs text-gray-500">Chart Laba Rugi, Ringkasan & Arus Kas dalam 1 PDF.</span> </div> </button>
...
function attachSettingsListeners() {
    ...
    document.getElementById("btn-gen-comprehensive-pdf").addEventListener("click", () => pdfService.generateComprehensiveFinancialPDF());
